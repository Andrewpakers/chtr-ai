export default function About() {
    return (
        <div>
            ...
            <p className="mb-3">Chtr.ai is a course project by <a className="underline" href="https://www.linkedin.com/in/andrewpakers/">Andrew Akers</a> for <a className="underline" href="https://www.theodinproject.com/">The Odin Project.</a> It was created as the <a className="underline" href="https://www.theodinproject.com/lessons/node-path-javascript-javascript-final-project">final project</a> for the Javascript module. It was built with <a className="underline" href="https://nextjs.org/">Next.js</a>, <a className="underline" href="https://tailwindcss.com/">Tailwind CSS</a>, <a className="underline" href="https://daisyui.com/">DaisyUI</a>, <a className="underline" href="https://firebase.google.com/">Google Firebase</a>, and <a className="underline" href="https://vercel.com/">Vercel</a>. All art was created using <a className="underline" href="https://www.midjourney.com/">Midjourney</a>.</p>
